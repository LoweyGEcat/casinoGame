...
//       if (newGameState.drawnCardVisible && newGameState.drawnCard) {
//         setDrawnCard(newGameState.drawnCard)
//         // After 2 seconds, emit the action to add card to hand
//         setTimeout(() => {
//           if (socket) {
//             socket.emit("player-action", { type: "addDrawnCardToHand" })
//           }
...
//   useEffect(() => {
//     const isPlayerTurn =
//       gameState && gameState.currentPlayerIndex === gameState.players.findIndex((p) => p.id === socket?.id)
...
//             {drawnCard && (
//               <div className="absolute left-32 top-0">
//                 <div className="w-[100px] h-[140px] bg-white rounded-lg shadow-lg flex items-center justify-center border-2 border-gray-300">
//                   <div
//                     className={`text-${drawnCard.suit === "♥" || drawnCard.suit === "♦" ? "red" : "black"}-600 text-2xl`}
//                   >
//                     {drawnCard.rank}
//                     {drawnCard.suit}
//                   </div>
